...
export const ProfilePage = () => {
	...
	const handleGoalSubmit = async (data: GoalRequest) => {
		try {
			...
			setGoalError(err.response?.data?.message || "Failed to save goals");
			throw err;
		}
	};
	...
	return (
		<div className="container mx-auto px-4 py-8 max-w-5xl">
			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
				...
				<div className="bg-white p-6 rounded-lg shadow-md lg:sticky lg:top-6 h-fit">
					<h2 className="text-xl font-semibold mb-4 text-gray-700">
						Calorie Goals
					</h2>
					{goalError && (
					...
					{isGoalLoading ? (
						...
						<div className="space-y-4">
							<GoalForm goal={goal} onSubmit={handleGoalSubmit} />
							{goal && (
